    ...
    <button
      ...
      className={
        deleteOrUpdateToShow === "delete"
          ? "bg-orange-default hover:bg-blue-default active:bg-blue-lighter h-7 w-7 rounded-full flex justify-center items-center"
          : "bg-blue-default hover:bg-orange-default active:bg-orange-lighter h-7 w-7 rounded-full flex justify-center items-center"
      }
